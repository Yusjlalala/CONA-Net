# -*- coding: utf-8 -*-
# @Time    : 27/02/2024 02:41
# @Author  : Aaron Yu
# @File    : CONANet_WOCONAM_FC.py
# @Software: PyCharm
...
class CONANet_WOCONAM_FC(nn.Module):
    def __init__(self, input_channels, output_channels):
        # def __init__(self):
        super(CONANet_WOCONAM_FC, self).__init__()
    ...
    def forward(self, x):
        ...
        # CAM 1
        connectivity_attention1 = enc1.clone().detach()
        ...
        # CAM 2
        connectivity_attention2 = enc2.clone().detach()

        # Bridge
        bridge = self.bridge(maxpool3)

        # CAM 3
        connectivity_attention3 = enc3.clone().detach()
